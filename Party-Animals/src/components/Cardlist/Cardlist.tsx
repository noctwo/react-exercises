...
import "./Cardlist.css"
import { Animal } from "../CardItem/CardItem";
...
return (
    <section className="animal-cards">
        {Animals.map((item, index) => (
            <CardItem key={index} emoji={item.emoji} name={item.name} species={item.species} habitat={item.habitat} diet={item.diet} lifespan={item.lifespan} funFacts={item.funFacts} />
        ))}
    </section>
)
